...
// a book's title and page count.
 ...
 var title = 'The Eye of the World';
 var pages = 344;
...
var sequel = `The Great Hunt is a sequel to the ${title}`;
...
var books = ['New Spring', 'The Eye of the World', 'The Great Hunt', 'The Dragon Reborn', 'The Shadow Rising'];
...
var belowTwoHundred = [12, 199, 1, 3, 144, 114, 17, 98, 100, 11, 33, 4,];
